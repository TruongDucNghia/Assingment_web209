...
const ProductDetail = (props: Props) => {
  return (
    <div className={cx('wrapper')}>
      <div className={cx('title-name')}>Samsung Galaxy A73 (5G) 256GB</div>
      <div className={cx('wrapper-main')}>
        <img src="https://res.cloudinary.com/dbpw1enlu/image/upload/v1659430053/Rectangle_1_syuxg3.png" alt="" className={cx('img-main')} />
        <div className={cx('sumary')}>
          <div className={cx('wrapper-price')}>
            <span className={cx('newPrice')}>10000000đ</span>
            <span className={cx('oldPrice')}>10000000đ</span>
          </div>
          <div className={cx('desc')}> Mô tả ngắn: Trước khi mua bất kỳ chiếc điện thoại nào, người dùng cũng sẽ quan tâm đến thiết kế sản phẩm trước. Với phiên bản A73, Samsung đã tạo nên một chiếc smartphone với vẻ ngoài mang đến cảm giác sang trọng và tinh tế.</div>
      ...
      <div className={cx('product-lq')}>
        ...
        <div className={cx('wrapper-pr')}>
          ...
          <ProductTop
            link='hehe'
            name='Ốp lưng Samsung Galaxy A73 2022 Silicone Cover'
